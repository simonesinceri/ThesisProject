...
%P1
yaw_0 = deg2rad(0); % DEVE ESSERE IN RADIANTI

load_system("Vehicle_dynamics_Circuit")
%open_system("Vehicle_dynamics_Radar")

%tic
z_in = zeros(d,1); % dopo toglilo con ET
...
save A_circuit_V3_20000_P2.mat w Ts lb_angSt ub_angSt gridx gridy gridvx gridvy gridyaw M N A passo_v passo_steerang d egoID lby uby lbx ubx lbvx ubvx lbvy ubvy safetyDist leftDistCG retroDistCG frontDistCG ub_angSt lb_angSt