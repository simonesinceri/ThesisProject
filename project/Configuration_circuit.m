...
%load circuit_10000_P3_ariprova.mat w

%load circuit_20000_P3_v2.mat w
%load circuit_10000_P4_v1.mat w
%load circuit_10000_P5_v1.mat w 
%load circuit_52000_P3_v3_newReward.mat w
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
% nuovo save P5
save circuit_50000_P3_Pang15.mat w Ts lb_angSt ub_angSt gridx gridy gridvx gridvy gridyaw M N A passo_v passo_steerang d egoID lby uby lbx ubx lbvx ubvx lbvy ubvy safetyDist leftDistCG retroDistCG frontDistCG ub_angSt lb_angSt